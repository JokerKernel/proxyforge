...
proxyforge config generate <sing-box|xray> --server HOST --port PORT --sni DOMAIN [--target HOST:PORT] [--user-name NAME] [--inbound-tag TAG] [--sing-box-fallback-guard] [--sing-box-fallback-port PORT] [--xray-fallback-guard] [--xray-fallback-port PORT]
