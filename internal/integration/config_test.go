	...
	for _, p := range providers {
		...
		t.Run(p.Name(), func(t *testing.T) {
			...
			configs := []struct {
				...
				n.LandingAccesses = []domain.LandingAccess{{Name: "landing-test", UserName: "landing-test", UUID: "5d5c5537-56a4-4b1a-a3bf-9e5a1b378769", Enabled: true}}
				n.RelayLinks = []domain.RelayLink{{Name: "relay-test", UserName: "relay-test", UUID: "11b50d17-8c92-4b5d-9449-245f3b70d7bd", Enabled: true, Upstream: domain.LandingPeer{
