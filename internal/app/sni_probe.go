...
func detectCDN(canonicalName, domain string, ipCount int) string {
	...
	providers := []cdnProvider{
		{name: "Akamai", suffixes: []string{"akamai.net", "akamaiedge.net", "akamaihd.net", "akamaized.net", "edgekey.net", "edgesuite.net", "akadns.net", "akamaitech.net", "akamai.com"}},
		{name: "AWS CloudFront", suffixes: []string{"cloudfront.net"}},
		{name: "Cloudflare", suffixes: []string{"cloudflare.com", "cloudflare.net", "cdn.cloudflare.net", "pages.dev", "trycloudflare.com", "workers.dev", "r2.dev"}},
		{name: "Fastly", suffixes: []string{"fastly.net", "fastlylb.net", "fastly.com"}},
		{name: "Microsoft/Azure CDN", suffixes: []string{"azureedge.net", "azurefd.net", "msedge.net", "trafficmanager.net", "gallerycdn.vsassets.io", "aspnetcdn.com", "office.net"}},
		{name: "Google CDN", suffixes: []string{"gstatic.com", "googleusercontent.com", "1e100.net", "googlehosted.com", "googlevideo.com"}},
		{name: "Apple CDN", suffixes: []string{"mzstatic.com", "cdn-apple.com", "apple-dns.net", "icloud-content.com"}},
		{name: "阿里云 CDN", suffixes: []string{"alicdn.com", "kunlun.com", "kunlunar.com", "kunlunle.com", "kunlunpi.com", "cdngslb.com", "taobaocdn.com", "tbcdn.cn"}},
		{name: "腾讯云 CDN", suffixes: []string{"qcloudcdn.com", "cdn.dnsv1.com", "tcdn.qq.com", "gdtimg.com", "qpic.cn", "myqcloud.com"}},
		{name: "百度云 CDN", suffixes: []string{"bdstatic.com", "bcebos.com", "bdydns.com"}},
		{name: "华为云 CDN", suffixes: []string{"hwcdrn.com", "cdn.myhuaweicloud.com"}},
		{name: "字节跳动 CDN", suffixes: []string{"bytecdn.cn", "byteimg.com", "pstatp.com", "bytescm.com", "douyincdn.com", "ibytedtos.com"}},
		{name: "网宿", suffixes: []string{"wscdns.com", "lxdns.com", "ourglb0.com", "wscloudcdn.com", "chinacache.net"}},
		{name: "七牛", suffixes: []string{"qiniucdn.com", "qnssl.com", "clouddn.com", "qiniudn.com"}},
		{name: "又拍云", suffixes: []string{"upaiyun.com", "upyun.com"}},
		{name: "金山云 CDN", suffixes: []string{"ks-cdn.com", "ksyuncdn.com"}},
		...
		{name: "Sucuri", suffixes: []string{"sucuri.net"}},
		{name: "KeyCDN", suffixes: []string{"kxcdn.com"}},
		{name: "StackPath", suffixes: []string{"stackpathcdn.com", "stackpathdns.com"}},
		{name: "CacheFly", suffixes: []string{"cachefly.net"}},
		{name: "Gcore", suffixes: []string{"gcdn.co"}},
		{name: "QUIC.cloud", suffixes: []string{"quic.cloud"}},
		{name: "Edgio", suffixes: []string{"llnwd.net", "llnw.net", "edgecastcdn.net"}},
		{name: "jsDelivr", suffixes: []string{"jsdelivr.net"}},
		{name: "Facebook CDN", suffixes: []string{"fbcdn.net"}},
		{name: "X CDN", suffixes: []string{"twimg.com"}},
		{name: "Cloudinary", suffixes: []string{"cloudinary.com"}},
		{name: "Imgix", suffixes: []string{"imgix.net"}},
		{name: "Shopify CDN", suffixes: []string{"shopifycdn.com", "shopifycloud.com"}},
		{name: "GitHub CDN", suffixes: []string{"githubassets.com"}},
		{name: "Amazon 图片 CDN", suffixes: []string{"images-amazon.com", "ssl-images-amazon.com", "media-amazon.com"}},
		{name: "Vercel", suffixes: []string{"vercel-dns.com", "vercel.app"}},
